...
+ (NSDictionary<NSString *, id> * _Nonnull)getSdkInfo SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC12PaymentezSDK8Receiver")
@interface Receiver : NSObject <ChallengeStatusReceiver>
