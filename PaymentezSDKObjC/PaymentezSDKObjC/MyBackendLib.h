...
+ (void) debitCardWithId:(NSString*)uid cardToken:(NSString*)cardToken sessionId:(NSString*)sessionId devReference:(NSString*)devReference amount:(double)amount description:(NSString*)description callback:(void (^)(PaymentezSDKError *error, PaymentezTransaction *transaction))callback;
