...
public typealias ValidationCallback = (_ cardType: PaymentCardType,
                                       _ cardImageUrl: String?,
                                       _ cvvLength: Int?,
                                       _ maskString: String?,
                                       _ showOtp: Bool) -> Void
...
@objcMembers open class PaymentCard: NSObject {
    ...
    public static func createCard(cardHolder: String,
                                  cardNumber: String,
                                  expiryMonth: NSInteger,
                                  expiryYear: NSInteger,
                                  cvc: String) -> PaymentCard? {
    ...
    public static func validate(cardNumber: String, callback: @escaping ValidationCallback){
        PaymentSDKClient.validateCard(cardNumber: cardNumber) { (data, err) in
            if err == nil {
                ...
                callback(PaymentCardType(rawValue: cardType) ?? PaymentCardType(rawValue: "")! ,
                         urlLogo,
                         cvvLength,
                         maskString,
                         showOtp)
