...
@property (strong, nonatomic) PaymentezDebitParameters *paymentezRequestParameters;
@property (strong, nonatomic) PaymentezCard *selectedCard;
...
- (IBAction)placeOrder:(id)sender {
    ...
    if (self.selectedCard != nil)
    {
        ...
        [MyBackendLib debitCardWithId:USERMODEL_UID cardToken:self.selectedCard.token sessionId:sessionId devReference:uuid amount:total description:@"Buy" callback:^(PaymentezSDKError *error, PaymentezTransaction *transaction) {
