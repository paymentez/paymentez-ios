...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PaymentezCard *card = (PaymentezCard*) self.cardList[indexPath.row];
...
{
    PaymentezCard *card = [self.cardList objectAtIndex:indexPath.row];
...
- (void)cardAdded:(PaymentezSDKError *)error :(PaymentezCard *)cardAdded
{
